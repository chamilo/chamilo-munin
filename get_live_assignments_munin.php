...
if (!empty($argv[1]) && $argv[1] == 'config') {
    ...
    $output .= "graph_title Chamilo live assignments v2\n";
...
//    echo "portal$portal.max 500\n";
    ...
    file_put_contents('/tmp/get_live_assignments_config', $output);
    exit;
}
...
file_put_contents('/tmp/get_live_assignments', $output);
